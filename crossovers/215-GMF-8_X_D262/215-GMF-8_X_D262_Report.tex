...
\begin{titlepage}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[text=AudioAccent, font=\fontsize{35}{50}\selectfont\bfseries, anchor=west] at ([xshift=2.5cm, yshift=0cm]current page.west) {215-GMF-8 \& D262};
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{215-GMF-8_X_D262_Reponse_SPL.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{215-GMF-8_X_D262_Impedance.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{215-GMF-8_X_D262_Schema.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\linewidth]{215-GMF-8_X_D262_Geometry.png}
\end{figure}
