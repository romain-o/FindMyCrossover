...
\begin{titlepage}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[text=AudioAccent, font=\fontsize{35}{50}\selectfont\bfseries, anchor=west] at ([xshift=2.5cm, yshift=0cm]current page.west) {2x 22W-8534G00 \& 4526ND};
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{2x_22W-8534G00_X_4526ND_Reponse_SPL.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{2x_22W-8534G00_X_4526ND_Impedance.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{2x_22W-8534G00_X_4526ND_Schema.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\linewidth]{2x_22W-8534G00_X_4526ND_Geometry.png}
\end{figure}
