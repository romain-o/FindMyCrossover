...
\begin{titlepage}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[text=AudioAccent, font=\fontsize{35}{50}\selectfont\bfseries, anchor=west] at ([xshift=2.5cm, yshift=0cm]current page.west) {2x 5FE120-8 \& SB26CDC-004-4};
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{2x_5FE120-8_X_SB26CDC-004-4_Reponse_SPL.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{2x_5FE120-8_X_SB26CDC-004-4_Impedance.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{2x_5FE120-8_X_SB26CDC-004-4_Schema.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\linewidth]{2x_5FE120-8_X_SB26CDC-004-4_Geometry.png}
\end{figure}
