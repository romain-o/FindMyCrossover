...
\begin{titlepage}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[text=AudioAccent, font=\fontsize{35}{50}\selectfont\bfseries, anchor=west] at ([xshift=2.5cm, yshift=0cm]current page.west) {2x DSA135-8 \& ND25FW-4};
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{2x_DSA135-8_X_ND25FW-4_Reponse_SPL.png}
\end{figure}

\section{Off-Axis Response}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1\linewidth]{2x_DSA135-8_X_ND25FW-4_Directivity.png}
            \end{figure}

\section{Directivity Heatmap}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1\linewidth]{2x_DSA135-8_X_ND25FW-4_Directivity_Heatmap.png}
            \end{figure}

\section{Impedance Response}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{2x_DSA135-8_X_ND25FW-4_Impedance.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{2x_DSA135-8_X_ND25FW-4_Schema.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\linewidth]{2x_DSA135-8_X_ND25FW-4_Geometry.png}
\end{figure}
