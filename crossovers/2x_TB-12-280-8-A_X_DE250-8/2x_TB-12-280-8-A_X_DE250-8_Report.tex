...
\begin{titlepage}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[text=AudioAccent, font=\fontsize{35}{50}\selectfont\bfseries, anchor=west] at ([xshift=2.5cm, yshift=0cm]current page.west) {2x TB-12-280-8-A \& DE250-8};
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{2x_TB-12-280-8-A_X_DE250-8_Reponse_SPL.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{2x_TB-12-280-8-A_X_DE250-8_Impedance.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{2x_TB-12-280-8-A_X_DE250-8_Schema.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\linewidth]{2x_TB-12-280-8-A_X_DE250-8_Geometry.png}
\end{figure}
