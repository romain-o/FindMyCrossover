...
\begin{titlepage}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[text=AudioAccent, font=\fontsize{35}{50}\selectfont\bfseries, anchor=west] at ([xshift=2.5cm, yshift=0cm]current page.west) {5NDL38-16 \& DE250-8};
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{5NDL38-16_X_DE250-8_Reponse_SPL.png}
\end{figure}

\section{Off-Axis Response (Directivity)}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{5NDL38-16_X_DE250-8_Directivity.png}
\end{figure}

\section{Directivity Heatmap}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{5NDL38-16_X_DE250-8_Directivity_Heatmap.png}
\end{figure}

\section{Impedance Response}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{5NDL38-16_X_DE250-8_Impedance.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{5NDL38-16_X_DE250-8_Schema.png}
\end{figure}

\section{Baffle Schematic}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{5NDL38-16_X_DE250-8_Geometry.png}
\end{figure}
