...
\begin{titlepage}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[text=AudioAccent, font=\fontsize{35}{50}\selectfont\bfseries, anchor=west] at ([xshift=2.5cm, yshift=0cm]current page.west) {DS215-8 \& DC28F-8};
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{DS215-8_X_DC28F-8_Reponse_SPL.png}
\end{figure}

\section{Off-Axis Response (Directivity)}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{DS215-8_X_DC28F-8_Directivity.png}
\end{figure}

\section{Directivity Heatmap}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{DS215-8_X_DC28F-8_Directivity_Heatmap.png}
\end{figure}

\section{Impedance Response}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{DS215-8_X_DC28F-8_Impedance.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{DS215-8_X_DC28F-8_Schema.png}
\end{figure}
