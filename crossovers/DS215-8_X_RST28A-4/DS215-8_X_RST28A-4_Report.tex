...
\begin{titlepage}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[text=AudioAccent, font=\fontsize{35}{50}\selectfont\bfseries, anchor=west] at ([xshift=2.5cm, yshift=0cm]current page.west) {DS215-8 \& RST28A-4};
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{DS215-8_X_RST28A-4_Reponse_SPL.png}
\end{figure}

\section{Off-Axis Response (Directivity)}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{DS215-8_X_RST28A-4_Directivity.png}
\end{figure}

\section{Directivity Heatmap}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{DS215-8_X_RST28A-4_Directivity_Heatmap.png}
\end{figure}

\section{Impedance Response}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{DS215-8_X_RST28A-4_Impedance.png}
\end{figure}

\chapter{Bill of Materials (BOM)}
The following table lists all the components required to build one crossover. For a stereo pair, please double the quantities.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{DS215-8_X_RST28A-4_Schema.png}
\end{figure}
