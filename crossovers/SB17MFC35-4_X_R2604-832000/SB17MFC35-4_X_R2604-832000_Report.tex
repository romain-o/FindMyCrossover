...
\begin{titlepage}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[text=AudioAccent, font=\fontsize{35}{50}\selectfont\bfseries, anchor=west] at ([xshift=2.5cm, yshift=0cm]current page.west) {SB17MFC35-4 \& R2604-832000};
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{SB17MFC35-4_X_R2604-832000_Reponse_SPL.png}
\end{figure}

\section{Off-Axis Response}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1\linewidth]{SB17MFC35-4_X_R2604-832000_Directivity.png}
            \end{figure}

\section{Directivity Heatmap}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1\linewidth]{SB17MFC35-4_X_R2604-832000_Directivity_Heatmap.png}
            \end{figure}

\section{Impedance Response}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{SB17MFC35-4_X_R2604-832000_Impedance.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{SB17MFC35-4_X_R2604-832000_Schema.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\linewidth]{SB17MFC35-4_X_R2604-832000_Geometry.png}
\end{figure}
