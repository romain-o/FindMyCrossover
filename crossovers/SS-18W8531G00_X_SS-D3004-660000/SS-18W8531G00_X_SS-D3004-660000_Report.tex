...
\begin{titlepage}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[text=AudioAccent, font=\fontsize{35}{50}\selectfont\bfseries, anchor=west] at ([xshift=2.5cm, yshift=0cm]current page.west) {ScanSpeak 18W8531G00};
    \node[text=AudioAccent, font=\fontsize{35}{50}\selectfont\bfseries, anchor=west] at ([xshift=2.5cm, yshift=-2cm]current page.west) {ScanSpeak D3004-660000};
    
    
    \node[text=gray, font=\Large, anchor=west] at ([xshift=2.5cm, yshift=-4cm]current page.west) {Complete Simulation Graphs \& Crossover Design};
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}lllrl@{}}
        ...
        R3 & Resistor & 10.0 $\Omega$ & 0.99 & \href{https://www.soundimports.eu/en/jantzen-audio-002-0802.html}{Link} \\
        \midrule
        \multicolumn{3}{r}{\textbf{Estimated Total}} & \textbf{77.89} & \\
        \bottomrule
    \end{tabular}
\end{table}
